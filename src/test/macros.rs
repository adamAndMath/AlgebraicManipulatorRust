...
macro_rules! type_id_gen {
    (($($v:tt)*), ) => (vec!($($v)*));
    (($($v:tt)*), $t:ident) => (type_id_gen!(($($v)* (Variance::Invariant, type_id!($t))), ));
    (($($v:tt)*), +$t:ident) => (type_id_gen!(($($v)* (Variance::Covariant, type_id!($t))), ));
    (($($v:tt)*), -$t:ident) => (type_id_vec!(($($v)* (Variance::Contravariant, type_id!($t))), ));
    (($($v:tt)*), $t:ident[$($g:tt)*]) => (type_id_gen!(($($v)* (Variance::Invariant, type_id!($t[$($g)*]))), ));
    (($($v:tt)*), +$t:ident[$($g:tt)*]) => (type_id_gen!(($($v)* (Variance::Covariant, type_id!($t[$($g)*]))), ));
    (($($v:tt)*), -$t:ident[$($g:tt)*]) => (type_id_gen!(($($v)* (Variance::Contravariant, type_id!($t[$($g)*]))), ));
    (($($v:tt)*), ($($t:tt)*)) => (type_id_gen!(($($v)* (Variance::Invariant, type_id!(($($t),*)))), ));
    (($($v:tt)*), +($($t:tt)*)) => (type_id_gen!(($($v)* (Variance::Covariant, type_id!(($($t),*)))), ));
    (($($v:tt)*), -($($t:tt)*)) => (type_id_gen!(($($v)* (Variance::Contravariant, type_id!(($($t),*)))), ));
...
macro_rules! type_id_tuple {
    ...
    (($($v:tt)*), $t:ident) => (type_id_tuple!(($($v)* type_id!($t)), ));
    (($($v:tt)*), $t:ident[$($g:tt)*]) => (type_id_tuple!(($($v)* type_id!($t[$($g)*])), ));
    (($($v:tt)*), ($($t:tt)*)) => (type_id_tuple!(($($v)* type_id!(($($t),*))), ));
