...
fn main() {
    ...
    let elements = parser::parse_file("
        fn not {
            true => false,
            false => true
        }

        proof DoubleNegative(b: Bool) = match b {
        ...
        proof And_Commutative(a: Bool, b: Bool) = match (a, b) {
        ...
        proof And_NeutralElement_Left(b: Bool) = match b {
        ...
        proof And_AbsorbativeElement_Left(b: Bool) = match b {
        ...
        proof And_Associative(a: Bool, b: Bool, c: Bool) = match b {
